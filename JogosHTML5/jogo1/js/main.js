function start(){//Inicio da função start
    ...
    var jogo = {};
    var velocidade = 5;
    var posicaoY = parseInt(Math.random() * 354);
    var TECLA = {
        W: 87,
        S: 83,
        D: 68
    ...
    //Verifica se o usúario pressionou alguma tecla
    ...
    function colisao(){//inicio função colisao()
    ...
    function explosao1(inimigo1X,inimigo1Y){
        ...
        function removeExplosao(){
            div.remove();
            window.cleatInterval(tempoExplosao);
            tempoExplosao=null;
    ...
    function explosao2(inimigo2X,inimigo2Y){
        ...
        div2.animate({width:200,opacity:0
        }, "alow");
        ...
        function removeExplosao2(){
            div2.remove();
            window.cleatInterval(tempoExplosao2);
            tempoExplosao2=null;
